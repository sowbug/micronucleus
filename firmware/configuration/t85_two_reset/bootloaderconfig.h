...
#define ENTRYMODE ENTRY_WATCHDOG_AND_EXT
...
#define ENTRY_WATCHDOG_AND_EXT  5
...
#elif ENTRYMODE==ENTRY_WATCHDOG_AND_EXT
  #define bootLoaderInit()
  #define bootLoaderExit()
#define bootLoaderStartCondition() (MCUSR&(_BV(WDRF)|_BV(EXTRF)))
#else
